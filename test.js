...
tape('renders text', function(test) {
  textOf(render({ content: [ 'Hello!' ] }), function(error, text) {
...
tape('renders definitions', function(test) {
  textOf(render({ content: [ { definition: 'Agreement' } ] }), function(error, text) {
    test.ifError(error, 'no error')
    test.assert(
...
tape('renders uses', function(test) {
  textOf(render({ content: [ { use: 'Agreement' } ] }), function(error, text) {
    test.ifError(error, 'no error')
    test.assert(
      text.indexOf('Agreement') > -1,
